...
public abstract class BetterStats
{
	...
	// ==================================================
	public static Text tt(String translationKey, Object... params) { return Text.translatable(translationKey, params); }
	public static Text lt(Object text) { return Text.literal(Objects.toString(text)); }
	// ==================================================
