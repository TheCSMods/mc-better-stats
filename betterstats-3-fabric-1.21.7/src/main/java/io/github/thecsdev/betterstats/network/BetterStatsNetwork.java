...
public final @Internal class BetterStatsNetwork
{
	...
	//
	public static final Identifier S2C_I_HAVE_BSS   = Identifier.of(getModID(), "s2c_bss");
	public static final Identifier C2S_I_HAVE_BSS   = Identifier.of(getModID(), "c2s_bss");
	public static final Identifier C2S_PREFERENCES  = Identifier.of(getModID(), "c2s_prf");      //v3.11+ | NV 3+
	public static final Identifier C2S_MCBS_REQUEST = Identifier.of(getModID(), "c2s_mcbs_req"); //v3.11+ | NV 3+
	public static final Identifier S2C_MCBS         = Identifier.of(getModID(), "s2c_mcbs");     //v3.11+ | NV 3+
	// ==================================================
