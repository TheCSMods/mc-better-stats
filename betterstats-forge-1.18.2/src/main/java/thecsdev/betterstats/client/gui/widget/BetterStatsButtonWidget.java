...
public class BetterStatsButtonWidget extends Button
{
	// ==================================================
	...
	public static final ResourceLocation STATS_BTN_BG_TEXTURE = new ResourceLocation(BetterStats.ModID, "textures/gui/stats_btn_bg.png");
	// ==================================================
	...
	public void renderButton(PoseStack matrices, int mouseX, int mouseY, float delta)
	{
	    ...
	    drawCenteredText(matrices, textRenderer, getMessage(),
	    		...
	    		j | (int)Math.ceil(this.alpha * 255.0F) << 24);
	}
