...
public class ScreenWithScissors extends Screen
{
	...
	public static final KeyMapping Key_Up = new KeyMapping("null", InputUtil.GLFW_KEY_UP, "null");
	public static final KeyMapping Key_Down = new KeyMapping("null", InputUtil.GLFW_KEY_DOWN, "null");
	public static final KeyMapping Key_Left = new KeyMapping("null", InputUtil.GLFW_KEY_LEFT, "null");
	public static final KeyMapping Key_Right = new KeyMapping("null", InputUtil.GLFW_KEY_RIGHT, "null");
	public static final KeyMapping Key_Enter = new KeyMapping("null", InputUtil.GLFW_KEY_ENTER, "null");
	public static final KeyMapping Key_KpEnter = new KeyMapping("null", InputUtil.GLFW_KEY_KP_ENTER, "null");
	// ==================================================
	...
	// ==================================================
	public void removeDrawable(Widget drawableChild) { swsOn_removeDrawable(drawableChild); }
	public boolean swsFocusOn(GuiEventListener element, boolean lookForwards) { return swsOn_swsFocusOn(element, lookForwards); }
	
	@Override
	public void render(PoseStack matrices, int mouseX, int mouseY, float delta) { swsOn_render(matrices, mouseX, mouseY, delta); }
	@Override
	...
	private void swsOn_removeDrawable(Widget drawableChild) {}
	
	//@Inject(method = "swsOn_swsFocusOn", at = @At("HEAD"), cancellable = true)
	private boolean swsOn_swsFocusOn(GuiEventListener element, boolean lookForwards) { throw new RuntimeException("This should not happen."); }
	
	//@Inject(method = "swsOn_render", at = @At("HEAD"), cancellable = true)
	private void swsOn_render(PoseStack matrices, int mouseX, int mouseY, float delta) {}
