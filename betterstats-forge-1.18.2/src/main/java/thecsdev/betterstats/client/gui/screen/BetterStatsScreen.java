...
public class BetterStatsScreen extends ScreenWithScissors implements StatsUpdateListener
{
	// ==================================================
	private static final Component DOWNLOADING_STATS_TEXT = tt("multiplayer.downloadingStats");
	private static final Component NO_SEARCH_RESULTS_TEXT = tt("betterstats.gui.search.no_results");
	...
	public enum CurrentTab
	{
		...
		CurrentTab(Component text) { this.text = text; }
	...
	public final StatsCounter statHandler;
	
	private boolean downloadingStats;
	// ==================================================
	public BetterStatsScreen(Screen parent, StatsCounter statHandler)
	{
		super(tt("gui.stats"));
		this.parent = parent;
