...
public final class BssClientPlayerBadges
{
	...
	public static final BssClientPlayerBadge_Custom ADVENTUROUS_TRAVELER;
	public static final BssClientPlayerBadge_Custom PERENNIAL_SURVIVOR;
	...
	static
	{
		...
		PlayerBadges.put(new Identifier(mId, "adventurous_traveler"), ADVENTUROUS_TRAVELER = new BssClientPlayerBadge_Custom("adventurous_traveler")
				.setUVCoords(200, 40, 20, 20));
		PlayerBadges.put(new Identifier(mId, "perennial_survivor"), PERENNIAL_SURVIVOR = new BssClientPlayerBadge_Custom("perennial_survivor")
				.setUVCoords(180, 20, 20, 20));
