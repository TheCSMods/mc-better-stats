package thecsdev.betterstats.api.registry;
...
public class BetterStatsRegistry
{
	...
	// ==================================================
	public static @Nullable String getItemWikiURL(Identifier itemId)
	{
	...
	public static @Nullable String getMobWikiURL(Identifier entityId)
	{
